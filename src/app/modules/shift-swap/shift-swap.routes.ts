...
export const routes: Routes = [
  ...
  { path: 'shift/new', component: ShiftFormComponent }, // Route for adding new shifts
  ...
  { path: 'swap-request/new', component: ShiftSwapRequestFormComponent }, // Form for creating new swap requests
